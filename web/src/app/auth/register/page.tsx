    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-primary-600 to-primary-900 flex items-center justify-center p-4">
        <div className="w-full max-w-md card p-8 text-center">
          ...
          <h2 className="text-xl font-semibold text-slate-900 mb-2">¡Revisá tu email!</h2>
          <p className="text-slate-500 text-sm mb-6">
            Te mandamos un link de confirmación a <strong>{email}</strong>. Hacé click en el link para activar tu cuenta.
          </p>
          <Link href="/auth/login" className="btn-primary inline-block">Volver al login</Link>
        </div>
      </div>
    )
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="card p-6">
          ...
          <div className="relative my-5">
            ...
            <div className="relative flex justify-center text-xs text-slate-500 bg-white px-3">o</div>
          </div>
