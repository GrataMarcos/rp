 ...
 * La clave es el valor que guarda la IA y se almacena en Sheets.
 */
const CATEGORIES = {
...
/**
 * Devuelve la info de una categoría o un fallback genérico.
 * @param {string} key
 */
function getCategory(key) {
  return CATEGORIES[key] || { emoji: '❓', label: key || 'Otros' };
}
